...
class JoinAttribute {
    ...
    get junctionAlias() {
        ...
        if (this.relation.isOwning) {
            return DriverUtils_1.DriverUtils.buildAlias(this.connection.driver, this.parentAlias, this.alias.name);
        }
        else {
            return DriverUtils_1.DriverUtils.buildAlias(this.connection.driver, this.alias.name, this.parentAlias);
        }
    }
